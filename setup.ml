...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1cb7492e0ce429d4d0c4a3384f8a59c1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Simple library to communicate unreliably in an IPv6 multicast network";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\167gw\161\214(,I\\\129\175\200\153\205_P";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
