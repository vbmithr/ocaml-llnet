...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0c50dd057dc062f5e8e6e3b8a48058f8) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_store.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "\173\225\234kR\199\005a\247\\\215\192\189GT\023";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
