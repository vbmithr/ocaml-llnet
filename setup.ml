...
(* OASIS_START *)
(* DO NOT EDIT (digest: a79649b4983284f1750bda422fe5185d) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_irmin.ml"});
               Executable
                 ({
                     cs_name = "test_rw";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\248>\r\247\175j\213\003\133\204\166\161\208W?=";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
