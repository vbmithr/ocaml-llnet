...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7a1871fd609d9201696bf80c81422cce) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build IrminDistributed.";
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "irminsule", true)
                        ];
                      bs_install =
                        [
                           (OASISExpr.EBool true, false);
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("irminsule", None);
                           InternalLibrary "llnet";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "llnet"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "test_membership.ml"});
               Executable
                 ({
                     cs_name = "test_ao";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "irminsule_test";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("irminsule.backend", None);
                           InternalLibrary "irmindistributed"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "test_ao.ml"});
               Executable
                 ({
                     cs_name = "test_rw";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_rw.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "\179R_l-d]0\\G\000\241\250\235\182\176";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
